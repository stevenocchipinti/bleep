...
const dummyData: Program[] = [
  ...
  }, */
  {
    ...
    emoji: "🧘",
    blocks: [
      { type: "timer", name: "1 Downward Dog", seconds: 5 },
      { type: "timer", name: "2 Upward Dog", seconds: 5 },
      { type: "timer", name: "3 Cobra", seconds: 5 },
      { type: "timer", name: "4 Downward Dog", seconds: 5 },
      { type: "timer", name: "5 Upward Dog", seconds: 5 },
      { type: "timer", name: "6 Cobra", seconds: 5 },
      { type: "timer", name: "7 Child's Pose", seconds: 5 },
    ],
  },
  {
    id: "athx",
